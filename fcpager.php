<?php
/**
 * @version 1.0 $Id: fcpager.php 1889 2014-04-26 03:25:28Z ggppdk $
 * @package Joomla
...
class plgFlexicontent_fieldsfcpager extends FCField
{
	static $field_types = array('fcpager');
	...
	function __construct( &$subject, $params )
	{
		...
		JPlugin::loadLanguage('plg_flexicontent_fields_fcpager', JPATH_ADMINISTRATOR);
	}
	...
	function onDisplayFieldValue(&$field, $item, $values=null, $prop='display')
	{
		...
		$page_link	= JText::_($field->parameters->get('page_link', ''));
		$page_label	= JText::_($field->parameters->get('page_label', ''));
		...
		if ($load_css)
			JFactory::getDocument()->addStyleSheet(JURI::root(true).'/plugins/flexicontent_fields/fcpager/'.(FLEXI_J16GE ? 'fcpagenav/' : '').'fcpagenav.css');	
